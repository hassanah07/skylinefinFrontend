        ...
        {DashboardSectionOneAPI.map((currElem, index) => {
          return (
            <div
              ...
              key={index}
            >
              <div className="border border-gray-300 border-opacity-75 p-6 rounded-lg bg-purple-100 dark:bg-black relative shadow-2xl shadow-yellow-600 dark:shadow-purple-600 hover:shadow-indigo-700 hover:dark:shadow-yellow-400 cursor-pointer">
