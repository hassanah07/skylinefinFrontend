...
const CustomerRecurringTable = ({ customerRecurringData = [], mySlag }) => {
  ...
  const customerRecurring = useMemo(
    ...
    <div className="mb-20">
      ...
      <div className="lg:col-span-2 bg-white dark:bg-gray-500 border rounded-lg shadow-sm p-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href={`/loggedInAdmin/recurring/addRecurring/${mySlag}`}
            className="text-sm hover:text-amber-500 cursor-pointer bg-indigo-800 py-2 px-3 rounded-md"
          >
            ➕Add
          </Link>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="text-sm">
                ...
                <th className="py-2 px-3">Recurring A/C</th>
                ...
                paginated.map((e, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3 px-3">{e.frequency ?? "-"}</td>

                      <td className="py-3 px-3">
                        <Link
                          href={`/loggedInAdmin/recurring/recurringCalculator/${e.recurringId}`}
                          className="text-sm hover:text-amber-500 hover:cursor-pointer hover:underline"
                        >
                          <FaCalculator
                            className="text-2xl"
                            title="Recurring Calculator"
                          />
                        </Link>
                      </td>
                      ...
                      <td className="py-3 px-3">
                        ...
                        >
                          <FaThList
                            ...
                            title="Recurring Amortization List"
                          />
                        </Link>
                      </td>
                      <td className="py-3 px-3">
                      ...
                      <td className="py-3 px-3">
                        <div className="flex items-center gap-4">
                          {e.stepI === false && (
                            <Link
                              href={`/loggedInAdmin/recurring/stepOne/${e._id}`}
                              className="text-sm hover:text-amber-500 hover:cursor-pointer hover:underline"
                            >
                              <TiTickOutline
                                className="text-2xl"
...
export default CustomerRecurringTable;
