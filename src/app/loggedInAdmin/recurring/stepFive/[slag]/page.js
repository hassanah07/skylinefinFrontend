  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_HOST}/api/loanProcessor/loanStepV`,
        {
          method: "POST",
          headers: {
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl p-6">
              ...
              <form className="space-y-6">
                    ...
                    <span className="flex">
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            assetType: e.target.value.slice(0, 14),
                          })
                        }
                      />
                    </span>
                    ...
                    <span className="flex">
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            assetValue: e.target.value.slice(0, 7),
                          })
                        }
                      />
                    </span>
                ...
                <div className="flex justify-center gap-5">
                  ...
                  <Link
                    href={`/loggedInAdmin/loan/stepSix/${mySlag}`}
