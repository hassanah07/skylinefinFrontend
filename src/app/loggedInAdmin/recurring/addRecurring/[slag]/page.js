                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="48">4 Year / 48 Month</option>
                      <option value="60">5 Year / 60 Month</option>
                      <option value="120">10 Year / 120 Month</option>
                      <option value="180">15 Year / 180 Month</option>
